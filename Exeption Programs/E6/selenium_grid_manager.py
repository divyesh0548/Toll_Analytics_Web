"""Docker Selenium Grid helpers for E6 (hub must be running; nodes can be auto-started)."""
...
def build_grid_status_url(remote_url: str) -> str:
...
def ensure_grid_ready(remote_url: str, timeout: int = 5) -> None:
